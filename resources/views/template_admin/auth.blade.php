        ...
        <div class="card my-5 col-xl-9 col-xxl-8 mx-auto rounded-4 overflow-hidden p-4">
            <div class="row g-4">
                <div class="col-lg-6 d-flex">
                    <div class="card-body">
                        <img src="{{ asset('template_admin/assets/images/logo/LogoPanjang.png') }}" class="mb-4"
                            width="145" alt="">
                        ...
                        <div class="row gy-2 gx-0 my-4">
                            {{-- <div class="col-12 col-lg-12">
                                <button
                                    ...
                                    <span class=""><img
                                            src="{{ asset('template_admin/assets/images/apps/05.png') }}"
                                            width="20" class="me-2" alt="">Sign in with Google</span>
                                </button>
                            </div>
                            <div class="col-12 col-lg-12">
                                <button
                                    class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                                    <span class=""><img
                                            src="{{ asset('template_admin/assets/images/apps/17.png') }}"
                                            width="20" class="me-2" alt="">Sign in with Facebook</span>
                                </button>
                            </div>
                            <div class="col-12 col-lg-12">
                                <button
                                    class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                                    <span class=""><img
                                            src="{{ asset('template_admin/assets/images/apps/18.png') }}"
                                            width="20" class="me-2" alt="">Sign in with LinkedIn</span>
                                </button>
                            </div> --}}
                        </div>
                        ...
                        <div class="form-body mt-4">
                            <form action="{{ route('admin.auth') }}" class="row g-3" method="post">
                                @csrf
                                <div class="col-12">
                                    <label for="inputEmailAddress" class="form-label">Email</label>
                                    <input type="email" class="form-control" value="{{ old('email') }}"
                                        name="email" id="inputEmailAddress" placeholder="jhon@example.com">
                                </div>
                                <div class="col-12">
                ...
                <div class="col-lg-6 d-lg-flex d-none">
                    <div class="p-3 rounded-4 w-100 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('template_admin/assets/images/auth/login1.png') }}" class="img-fluid"
                            alt="">
                    </div>
                </div>
